...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	ttImage.urlPath = [OLDSessionViewController thumbnailURL:regID];
...
- (void)viewDidLoad {
	...
	if (self.schedules == nil){
		...
		NSURLRequest* request = [NSURLRequest requestWithURL: [NSURL URLWithString:[OLDSessionViewController schedulesURL]]
