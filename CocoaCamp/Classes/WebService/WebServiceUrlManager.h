...
@interface WebServiceUrlManager : NSObject{
    NSURL *attendeeListUrl, *twitterSearchUrl, *rssNewsUrl, *newsWebUrl;
    NSString *twitterFallSearchString;
    NSArray *sessionScheduleUrlList;
}

@property(readonly, nonatomic, copy) NSURL *attendeeListUrl, *twitterSearchUrl, *rssNewsUrl, *newsWebUrl;
